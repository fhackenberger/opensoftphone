...
public class InteractiveSplashHandler extends BasicSplashHandler {
	...
	public void init(final Shell splash) {
		...
		// loading until the close loginButton is clicked.
		doEventLoop();
	...
	private void doEventLoop() {
		...
		Rectangle progressRect = StringConverter.asRectangle(
				progressRectString, new Rectangle(5, 275, 445, 15));
	...
	private void createUIListeners() {
		// Create the OK loginButton listeners
		createUIListenersButtonOK();
		// Create the cancel loginButton listeners
	...
	private void handleButtonOKWidgetSelected() {
		...
		if ((username.length() > 0) &&
			...
			MessageDialog.openError(
					getSplash(),
					Messages.InteractiveSplashHandler_0,  //NON-NLS-1
					Messages.InteractiveSplashHandler_1);  //NON-NLS-1
		}
	}
	...
	private void createUI() {
		...
		createUILabelBlank();
		// Create the OK loginButton
		createUIButtonOK();
		// Create the cancel loginButton
	...
	private void createUIButtonCancel() {
		...
		fButtonCancel.setText(Messages.InteractiveSplashHandler_2); //NON-NLS-1
	...
	private void createUIButtonOK() {
		...
		fButtonOK.setText(Messages.InteractiveSplashHandler_3); //NON-NLS-1
		// Configure layout data
		GridData data = new GridData(SWT.NONE, SWT.NONE, false, false);
		data.widthHint = F_BUTTON_WIDTH_HINT;
		data.verticalIndent = 10;
	...
	private void createUILabelPassword() {
		// Create the label
		Label label = new Label(fCompositeLogin, SWT.NONE);
		label.setText(Messages.InteractiveSplashHandler_4); //NON-NLS-1
		// Configure layout data
...
//		ImageDescriptor id = IconStore..getImageDescriptor("acoveo.png");
//		Image img = new Image(getSplash().getDisplay(), id.getImageData());
//		spanner.setBackgroundImage(img);
	}
