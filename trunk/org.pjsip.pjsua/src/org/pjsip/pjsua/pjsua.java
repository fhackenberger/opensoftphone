...
public class pjsua implements pjsuaConstants {
  ...
  public synchronized static SWIGTYPE_p_pjmedia_snd_stream pjmedia_snd_port_get_snd_stream(pjmedia_snd_port snd_port) {
    long cPtr = pjsuaJNI.pjmedia_snd_port_get_snd_stream(pjmedia_snd_port.getCPtr(snd_port), snd_port);
    return (cPtr == 0) ? null : new SWIGTYPE_p_pjmedia_snd_stream(cPtr, false);
  }
