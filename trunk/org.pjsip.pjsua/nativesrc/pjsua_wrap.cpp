...
void SwigDirector_Callback::on_stream_created(pjsua_call_id call_id, pjmedia_session *sess, unsigned int stream_idx, pjmedia_port **pm_port) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    *((pjmedia_port ***)&jpm_port) = (pjmedia_port **) pm_port; 
    jenv->CallStaticVoidMethod(Swig::jclass_pjsuaJNI, Swig::director_methids[4], swigjobj, jcall_id, jsess, jstream_idx, jpm_port);
    if (jenv->ExceptionOccurred()) return ;
  } else {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object");
  }
...
SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1param_1setting_1enc_1fmtp_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_codec_param_setting *arg1 = (pjmedia_codec_param_setting *) 0 ;
  pjmedia_codec_fmtp arg2 ;
  pjmedia_codec_fmtp *argp2 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjmedia_codec_param_setting **)&jarg1; 
  argp2 = *(pjmedia_codec_fmtp **)&jarg2; 
  if (!argp2) {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "Attempt to dereference null pjmedia_codec_fmtp");
    return ;
  }
  arg2 = *argp2; 
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1param_1setting_1enc_1fmtp_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_codec_param_setting *arg1 = (pjmedia_codec_param_setting *) 0 ;
  pjmedia_codec_fmtp result;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjmedia_codec_param_setting **)&jarg1; 
  result =  ((arg1)->enc_fmtp);
  *(pjmedia_codec_fmtp **)&jresult = new pjmedia_codec_fmtp((const pjmedia_codec_fmtp &)result); 
  return jresult;
}


SWIGEXPORT void JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1codec_1param_1setting_1dec_1fmtp_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2) {
  pjmedia_codec_param_setting *arg1 = (pjmedia_codec_param_setting *) 0 ;
  pjmedia_codec_fmtp arg2 ;
  pjmedia_codec_fmtp *argp2 ;
...
SWIGEXPORT jlong JNICALL Java_org_pjsip_pjsua_pjsuaJNI_pjmedia_1snd_1port_1get_1snd_1stream(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  pjmedia_snd_port *arg1 = (pjmedia_snd_port *) 0 ;
  pjmedia_snd_stream *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(pjmedia_snd_port **)&jarg1; 
  result = (pjmedia_snd_stream *)pjmedia_snd_port_get_snd_stream(arg1);
  *(pjmedia_snd_stream **)&jresult = result; 
  return jresult;
}
